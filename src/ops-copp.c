                                         ...
                                         opennsl_field_entry_t* ingress_fp_entry)
{
     ...
     * on the following rules:-
     * 1. L4 destination port is 3784 for bfd_multi_hop
...
/*
 * ops_copp_ingress_fp_bfd_L4_src_port
 *
 * This function programs the qualifiers for identifying a BFD
 * packet in ingress pipeline for source port.
 */
