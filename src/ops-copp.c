 ...
 */
opennsl_field_group_t ops_copp_ingress_fp_group_array[OPS_COPP_MAX_UNITS];

/*
 * Egress group ids per hardware unit
 */
opennsl_field_group_t ops_copp_egress_fp_group_array[OPS_COPP_MAX_UNITS];

/*
 * Index counter for global rx rules for control packet class.
 */
int ops_copp_packet_class_rx_index[OPS_COPP_MAX_UNITS];
 ...
 */
struct ops_copp_fp_rule_t ops_copp_packet_class_t[] =
{
 ...
 */
inline char* ops_copp_get_name_from_cpu_queue_number (uint32 cpu_queue)
{
 ...
 */
char* ops_copp_to_lowercase (char* str)
{
    int len = strlen(str);
    int index;
 ...
 */
int ops_copp_create_egress_policer_id (uint32 unit,
 ...
 *
 * This function creates a stats-id for stroing stats for dropped and
 * accepted control packets in an egress FP entry. This function is called
 * per hardware unit.
 */
int ops_copp_create_egress_stat_id (uint32 unit, int* stat_id)
{
    int retval = -1;
    int num_stat = 4;
     ...
     *
     * TODO:- Need to add bcmFieldStatYellowBytes and
     *        bcmFieldStatYellowPackets to the statistics.
     */
 ...
 * by calling free().
 */
inline void ops_copp_fp_entry_cleanup (uint32 unit,
 ...
 * by calling free().
 */
inline void ops_copp_fp_policer_cleanup (uint32 unit,
 ...
 * by calling free().
 */
inline void ops_copp_fp_statid_cleanup (uint32 unit, int* stat_id)
{
    if (!stat_id) {
        return;
    }
...
/*
 * ops_copp_egress_fp_acl_logging_function_pointer
 *
 * This function programs the qualifiers for identifying an ACL Logging
 * packet in egress pipeline.
 */
int ops_copp_egress_fp_acl_logging_function_pointer (
                                      uint32 unit,
...
/*
 * ops_copp_ingress_fp_broadcast_arp_function_pointer
 *
 * This function programs the qualifiers for identifying an broadcast ARP
 * packet in ingress pipeline.
 */
int ops_copp_ingress_fp_broadcast_arp_function_pointer (
                                      uint32 unit,
...
/*
 * ops_copp_egress_fp_broadcast_arp_function_pointer
 *
 * This function programs the qualifiers for identifying an broadcast ARP
 * packet in egress pipeline.
 */
int ops_copp_egress_fp_broadcast_arp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_ingress_fp_unicast_arp_function_pointer
 *
 * This function programs the qualifiers for identifying an unicast ARP
 * packet in ingress pipeline.
 */
int ops_copp_ingress_fp_unicast_arp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry)
{
    int32                  retval = -1;
...
/*
 * ops_copp_egress_fp_unicast_arp_function_pointer
 *
 * This function programs the qualifiers for identifying an unicast ARP
 * packet in egress pipeline.
 */
int ops_copp_egress_fp_unicast_arp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_ingress_fp_lacp_function_pointer
 *
 * This function programs the qualifiers for identifying a LACP
 * packet in ingress pipeline.
 */
int ops_copp_ingress_fp_lacp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry)
{
    int32                  retval = -1;
...
/*
 * ops_copp_egress_fp_lacp_function_pointer
 *
 * This function programs the qualifiers for identifying a LACP
 * packet in egress pipeline.
 */
int ops_copp_egress_fp_lacp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_ingress_fp_lldp_function_pointer
 *
 * This function programs the qualifiers for identifying a LLDP
 * packet in ingress pipeline.
 */
int ops_copp_ingress_fp_lldp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry)
{
    int32                  retval = -1;
...
/*
 * ops_copp_egress_fp_lldp_function_pointer
 *
 * This function programs the qualifiers for identifying a LLDP
 * packet in egress pipeline.
 */
int ops_copp_egress_fp_lldp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_egress_fp_stp_function_pointer
 *
 * This function programs the qualifiers for identifying a STP
 * packet (for bridges and provider bridges) in egress pipeline.
 */
int ops_copp_egress_fp_stp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_ingress_fp_bgp_function_pointer
 *
 * This function programs the qualifiers for identifying a BGP packet
 * in ingress pipeline.
 */
int ops_copp_ingress_fp_bgp_function_pointer (
                                   uint32 unit,
                                   opennsl_field_entry_t* ingress_fp_entry)
{
...
/*
 * ops_copp_egress_fp_bgp_function_pointer
 *
 * This function programs the qualifiers for identifying a BGP packet
 * in egress pipeline.
 */
int ops_copp_egress_fp_bgp_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* egress_fp_entry,
                                uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_ingress_fp_dhcpv4_function_pointer
 *
 ...
 */
int ops_copp_ingress_fp_dhcpv4_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* ingress_fp_entry)
{
...
/*
 * ops_copp_egress_fp_dhcpv4_function_pointer
 *
 * This function programs the qualifiers for identifying a DHCPv4 packet
 * in egress pipeline. The DHCPv4 packet in destined for the DHCP server.
 */
int ops_copp_egress_fp_dhcpv4_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* egress_fp_entry,
                                uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_ingress_fp_dhcpv6_function_pointer
 *
 ...
 */
int ops_copp_ingress_fp_dhcpv6_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* ingress_fp_entry)
{
...
/*
 * ops_copp_egress_fp_dhcpv6_function_pointer
 *
 * This function programs the qualifiers for identifying a DHCPv6 packet
 * in egress pipeline. The DHCPv6 packet in destined for the DHCP server.
 */
int ops_copp_egress_fp_dhcpv6_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* egress_fp_entry,
                                uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_ingress_fp_icmpv4_ucast_function_pointer
 *
 * This function programs the qualifiers for identifying a ICMPv4 unicast
 * packet in ingress pipeline.
 */
int ops_copp_ingress_fp_icmpv4_ucast_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* ingress_fp_entry)
{
    uint8                  address_data = OPS_COPP_DST_IP_LOCAL_DATA;
...
/*
 * ops_copp_egress_fp_icmpv4_ucast_function_pointer
 *
 * This function programs the qualifiers for identifying a ICMPv4 unicast
 * packet in egress pipeline.
 */
int ops_copp_egress_fp_icmpv4_ucast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_ingress_fp_icmpv4_bcast_function_pointer
 *
 * This function programs the qualifiers for identifying a ICMPv4 broadcast
 * packet in ingress pipeline.
 */
int ops_copp_ingress_fp_icmpv4_bcast_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* ingress_fp_entry)
{
    uint8                  prot_type = OPS_COPP_IP_PROTOCOL_IPV4_NUMBER_ICMP;
...
/*
 * ops_copp_ingress_fp_icmpv4_mcast_function_pointer
 *
 * This function programs the qualifiers for identifying a ICMPv4 multicast
 * packet in ingress pipeline.
 */
int ops_copp_ingress_fp_icmpv4_mcast_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* ingress_fp_entry)
{
    uint8                  prot_type = OPS_COPP_IP_PROTOCOL_IPV4_NUMBER_ICMP;
...
/*
 * ops_copp_egress_fp_icmpv4_bcast_mcast_function_pointer
 *
 * This function programs the qualifiers for identifying a ICMPv4 broadcast
 * or multicast packet in egress pipeline.
 */
int ops_copp_egress_fp_icmpv4_bcast_mcast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_ingress_fp_icmpv6_ucast_function_pointer
 *
 * This function programs the qualifiers for identifying a ICMPv6 unicast
 * packet in ingress pipeline.
 */
int ops_copp_ingress_fp_icmpv6_ucast_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* ingress_fp_entry)
{
    uint8                  address_data = OPS_COPP_DST_IP_LOCAL_DATA;
...
/*
 * ops_copp_egress_fp_icmpv6_ucast_function_pointer
 *
 * This function programs the qualifiers for identifying a ICMPv6 unicast
 * packet in ingress pipeline.
 */
int ops_copp_egress_fp_icmpv6_ucast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_ingress_fp_icmpv6_mcast_function_pointer
 *
 * This function programs the qualifiers for identifying a ICMPv6 multicast
 * packet in ingress pipeline.
 */
int ops_copp_ingress_fp_icmpv6_mcast_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* ingress_fp_entry)
{
    uint8                  prot_type = OPS_COPP_IP_PROTOCOL_IPV6_NUMBER_ICMP;
...
/*
 * ops_copp_egress_fp_icmpv6_mcast_function_pointer
 *
 * This function programs the qualifiers for identifying a ICMPv6 multicast
 * packet in ingress pipeline.
 */
int ops_copp_egress_fp_icmpv6_mcast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_ingress_fp_ospfv2_dr_mcast_function_pointer
 *
 * This function programs the qualifiers for identifying a OSPFv2 dr
 * multicast packet in ingress pipeline.
 */
int ops_copp_ingress_fp_ospfv2_dr_mcast_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* ingress_fp_entry)
{
...
/*
 * ops_copp_ingress_fp_ospfv2_all_mcast_function_pointer
 *
 * This function programs the qualifiers for identifying a OSPFv2 all
 * multicast packet in ingress pipeline.
 */
int ops_copp_ingress_fp_ospfv2_all_mcast_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* ingress_fp_entry)
{
    uint8                  prot_type = OPS_COPP_IP_PROTOCOL_IP_NUMBER_OSPFV2;
...
/*
 * ops_copp_egress_fp_ospfv2_mcast_function_pointer
 *
 * This function programs the qualifiers for identifying an OSPFv2
 * multicast packet in egress pipeline.
 */
int ops_copp_egress_fp_ospfv2_mcast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_ingress_fp_ospfv2_ucast_function_pointer
 *
 * This function programs the qualifiers for identifying a OSPFv2 unicast
 * packet in ingress pipeline.
 */
int ops_copp_ingress_fp_ospfv2_ucast_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* ingress_fp_entry)
{
    uint8                  address_data = OPS_COPP_DST_IP_LOCAL_DATA;
...
/*
 * ops_copp_egress_fp_ospfv2_ucast_function_pointer
 *
 * This function programs the qualifiers for identifying a OSPFv2 unicast
 * packet in ingress pipeline.
 */
int ops_copp_egress_fp_ospfv2_ucast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_ingress_fp_ipv4_options_function_pointer
 *
 * This function programs the qualifiers for identifying an IPv4 options
 * packet in ingress pipeline.
 */
int ops_copp_ingress_fp_ipv4_options_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* ingress_fp_entry)
{
    uint8                  address_data = OPS_COPP_DST_IP_LOCAL_DATA;
...
/*
 * ops_copp_egress_fp_ipv4_options_function_pointer
 *
 * This function programs the qualifiers for identifying an IPv4 options
 * packet in egress pipeline.
 */
int ops_copp_egress_fp_ipv4_options_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_ingress_fp_ipv6_options_function_pointer
 *
 * This function programs the qualifiers for identifying an IPv6 options
 * packet in ingress pipeline.
 */
int ops_copp_ingress_fp_ipv6_options_function_pointer (
                                uint32 unit,
                                opennsl_field_entry_t* ingress_fp_entry)
{
    uint8                  address_data = OPS_COPP_DST_IP_LOCAL_DATA;
...
/*
 * ops_copp_egress_fp_ipv6_options_function_pointer
 *
 * This function programs the qualifiers for identifying an IPv6 options
 * packet in egress pipeline.
 */
int ops_copp_egress_fp_ipv6_options_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_sflow_function_pointer
 *
 * This function programs the global rx rule for sflow packets.
 */
int ops_copp_sflow_function_pointer (uint32 unit)
{
    uint8                   int_prio=0;
...
/*
 * ops_copp_egress_fp_sflow_function_pointer
 *
 * This function programs the qualifiers for matching all sflow
 * packets in egress pipeline.
 */
int ops_copp_egress_fp_sflow_function_pointer (
                                   uint32 unit,
                                   opennsl_field_entry_t* egress_fp_entry,
                                   uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_unknown_ip_unicast_function_pointer
 *
 * This function programs the rx rule for unknown IP packets.
 */
int ops_copp_unknown_ip_unicast_function_pointer (uint32 unit)
{
    uint8                   int_prio=0;
    uint8                   int_prio_mask=0;
    uint32                  packet_type = 0;
...
/*
 * ops_copp_egress_fp_unknown_ip_unicast_function_pointer
 *
 * This function programs the qualifiers for matching all unknown unicast IP
 * packets in egress pipeline.
 */
int ops_copp_egress_fp_unknown_ip_unicast_function_pointer (
                                   uint32 unit,
                                   opennsl_field_entry_t* egress_fp_entry,
                                   uint8 ingress_cpu_queue_number)
{
...
/*
 * ops_copp_unclassified_function_pointer
 *
 ...
 */
int ops_copp_unclassified_function_pointer (uint32 unit)
{
...
/*
 * ops_copp_egress_fp_unclassified_function_pointer
 *
 ...
 */
int ops_copp_egress_fp_unclassified_function_pointer (
                                   uint32 unit,
                                   opennsl_field_entry_t* egress_fp_entry,
                                   uint8 ingress_cpu_queue_number)
{
 ...
 * packet is defined.
 */
int ops_copp_packet_class_programmer(
                              uint32 unit,
                              enum ops_copp_packet_class_code_t packet_class)
{
    int32                  retval = -1;
    ...
    struct ops_copp_fp_rule_t* copp_packet_class =
                     &ops_copp_packet_class_t[packet_class];
    ...
    if (copp_packet_class->ops_copp_packet_class_function_pointer) {
        ...
        /*
         * TODO: Change this debug to VLOG_DBG
         */
        VLOG_INFO("     Packet class: Successfully programmed the "
 ...
 */
int ops_copp_ingress_fp_programmer (
                              uint32 unit,
                              enum ops_copp_packet_class_code_t packet_class,
                              uint32* ingress_fp_queue)
{
    ...
    if (if_init_ingress_fp_program) {
         ...
         * TODO: Change this debug to VLOG_DBG
         */
        VLOG_INFO("Create a new ingress FP %s entry with default queue number "
         ...
         * TODO: Change this debug to VLOG_DBG
         */
        VLOG_INFO("     Ingress: Successfully programmed the FP rule "
    ...
    if (if_config_ingress_fp_program) {
        ...
        if (copp_packet_class->ops_copp_ingress_fp_queue_number ==
            *ingress_fp_queue) {
             ...
             * TODO: Change this debug to VLOG_DBG
             */
            VLOG_INFO("     Ingress: The previous CPU queue "
             ...
             * TODO: Change this debug to VLOG_DBG
             */
            VLOG_INFO("     Ingress: Successfully reprogrammed the FP rule "
 ...
 */
int ops_copp_egress_fp_programmer (
                               uint32 unit,
                               enum ops_copp_packet_class_code_t packet_class,
                               ...
                               uint32* egress_fp_burst)
{
    ...
    if (if_init_egress_fp_program) {
         ...
         * TODO: Change this debug to VLOG_DBG
         */
        VLOG_INFO("Create a new egress FP %s entry with default rate/burst",
                  copp_packet_class->ops_copp_packet_name);
         ...
         * TODO: Change this debug to VLOG_DBG
         */
        VLOG_INFO("     Egress: Successfully programmed the FP rule "
                  "for %s", copp_packet_class->ops_copp_packet_name);
    }
    ...
    if (if_config_egress_fp_program) {
        if ((copp_packet_class->ops_copp_egress_fp_rate == *egress_fp_rate)
             ...
             * TODO: Change this debug to VLOG_DBG
             */
            VLOG_INFO("     Egress: The current rate/burst %u/%u is same new "
             ...
             * TODO: Change this debug to VLOG_DBG
             */
            VLOG_INFO("     Egress: Successfully updated rate/burst %u/%u "
 ...
 * group ids.
 */
int ops_copp_ingress_fp_group_create ()
{
 ...
 * group ids.
 */
int ops_copp_egress_fp_group_create ()
{
 ...
 */
int ops_copp_program_fp_defaults ()
{
    int32                  retval = -1;
    int                    unit_iterator;
    int                    fp_rule_iterator;
 ...
 */
int ops_copp_set_packet_class_config (struct ops_copp_config_t* copp_config)
{
    int                        retval;
    int                        unit_iterator;
 ...
 */
int ops_copp_get_packet_class_stats (struct ops_copp_stats_t* copp_stats)
{
    struct ops_copp_fp_rule_t*          copp_packet_class;
 ...
 */
int ops_copp_packet_stats_to_string (struct ops_copp_stats_t copp_stats,
 ...
 */
int ops_copp_packet_config_to_string (struct ops_copp_fp_rule_t copp_fp_rule,
                                      char* ops_copp_packet_stat_buffer,
                                      uint32 bytes_already_written,
                                      uint32 max_length)
{
