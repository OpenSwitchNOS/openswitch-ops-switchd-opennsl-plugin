...
*/
opennsl_field_group_t ops_l3intf_ingress_stats_group_id_for_hw_unit(int unit)
{
...
* the given hardware unit.
*/
opennsl_field_group_t ops_l3intf_egress_stats_group_id_for_hw_unit(int unit)
{
