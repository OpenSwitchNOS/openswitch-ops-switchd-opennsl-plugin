 ...
 */
opennsl_error_t
ops_subinterface_fp_create(opennsl_port_t hw_port, int hw_unit)
{
    ...
    if (OPENNSL_FAILURE(rc)) {
        VLOG_ERR("Failed to create FP entry for subinterface \
                Unit=%d port=%d rc=%s",
                hw_unit, hw_port, opennsl_errmsg(rc));
        ops_subinterface_fp_destroy(hw_port, hw_unit);
        return rc;
    }
 ...
 */
opennsl_error_t
ops_subinterface_fp_destroy(opennsl_port_t hw_port, int hw_unit)
{
    opennsl_error_t rc = OPENNSL_E_NONE;
    struct netdev_bcmsdk *netdev = netdev_from_hw_id(hw_unit, hw_port);
    ...
    VLOG_DBG("%s, Delete entry success unit = %d, port %d",
              __FUNCTION__, hw_unit, hw_port);
    ...
    VLOG_DBG("%s, Delete group success unit = %d, port %d",
              __FUNCTION__, hw_unit, hw_port);
