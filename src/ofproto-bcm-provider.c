                  ...
                  char *next_hop_mac_addr, int *l3_egress_id)
{
    ...
    struct bcmsdk_provider_ofport_node *port;
    const char *type;
    uint32_t egr_stat_id = 0; /* set dummy value */
    uint32_t egr_num_id = 0; /* set dummy value */
    int rc = 0;
    ...
    rc = opennsl_stat_group_create(0, opennslStatObjectEgrL3Intf,
    ...
    rc = opennsl_l3_egress_stat_attach(0, *l3_egress_id, egr_stat_id);
    if (rc) {
