...
/* ops_routing_check_is_internal_vlan
 *
 * This function checks if the vlan is an internal VLAN.
 */
bool
ops_routing_check_is_internal_vlan (opennsl_vlan_t vlan)
{
                                ...
                                unsigned char *mac, struct netdev *netdev)
{
    ...
    char vlan[VLAN_ID_MAX_LENGTH];
    snprintf(vlan, VLAN_ID_MAX_LENGTH, "%d", vlan_id);
    shash_add_once(&internal_vlans, vlan, &vlan_id);
                                 ...
                                 opennsl_l3_intf_t *l3_intf, struct netdev *netdev)
{
    ...
    char vlan[VLAN_ID_MAX_LENGTH];
    snprintf(vlan, VLAN_ID_MAX_LENGTH, "%d", vlan_id);
    shash_find_and_delete(&internal_vlans, vlan);
