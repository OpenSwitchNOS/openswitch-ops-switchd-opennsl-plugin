...
bool
ops_egress_lookup_from_route(int vrf, char *route_prefix, opennsl_if_t * l3_egr_id)
{
 ...
 */
bool
ops_egress_lookup_from_dst_ip(int vrf, uint32_t ip_dst, opennsl_if_t * l3_egr_id)
{
    uint32_t prefix, len;
