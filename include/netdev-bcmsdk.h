...
extern opennsl_error_t ops_subinterface_fp_create(opennsl_port_t hw_port, int hw_unit);
extern opennsl_error_t ops_subinterface_fp_destroy(opennsl_port_t hw_port, int hw_unit);
