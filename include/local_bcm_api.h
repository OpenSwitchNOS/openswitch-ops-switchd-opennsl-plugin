/*
 * This is a temporary header file which has the extern definitions of
 * the bcm/opennsl apis. This file needs to be removed once we get the
 * opennsl drop from bcm.
 */
...
#define opennsl_l3_egress_stat_detach bcm_l3_egress_stat_detach
#define opennsl_l3_ingress_stat_detach bcm_l3_ingress_stat_detach
#define opennsl_stat_group_destroy bcm_stat_group_destroy
