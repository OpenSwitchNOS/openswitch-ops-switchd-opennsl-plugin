 ...
 * packets.
 */
extern int ops_copp_egress_fp_acl_logging_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_broadcast_arp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_broadcast_arp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_unicast_arp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_unicast_arp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_lacp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_lacp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_lldp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_lldp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_stp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_stp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_bgp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_bgp_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_dhcpv4_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_dhcpv4_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_dhcpv6_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_dhcpv6_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_icmpv4_ucast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_icmpv4_ucast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_icmpv4_bcast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_ingress_fp_icmpv4_mcast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_icmpv4_bcast_mcast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_icmpv6_ucast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_icmpv6_ucast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_icmpv6_mcast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_icmpv6_mcast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_ospfv2_dr_mcast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_ingress_fp_ospfv2_all_mcast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_ospfv2_mcast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_ospfv2_ucast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_ospfv2_ucast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_ipv4_options_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_ipv4_options_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_ingress_fp_ipv6_options_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* ingress_fp_entry);
extern int ops_copp_egress_fp_ipv6_options_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_sflow_function_pointer (uint32 unit);
extern int ops_copp_egress_fp_sflow_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_unknown_ip_unicast_function_pointer (uint32 unit);
extern int ops_copp_egress_fp_unknown_ip_unicast_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
extern int ops_copp_unclassified_function_pointer (uint32 unit);
extern int ops_copp_egress_fp_unclassified_function_pointer (
                                      uint32 unit,
                                      opennsl_field_entry_t* egress_fp_entry,
                                      uint8 ingress_cpu_queue_number);
