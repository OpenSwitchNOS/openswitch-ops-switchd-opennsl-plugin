...
Broadcom ASIC configuration originating from the OpenSwitch NoS components and configuration originating from OpenFlow controller applications are integrated using a strategy discussed in the Hybrid Model section below.
