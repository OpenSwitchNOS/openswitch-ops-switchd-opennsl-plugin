...
- Create an FP rule on the parent port to drop packets that have a destination MAC not matching MyStationTCAM; to avoid switching on the subinterface VLAN ID.
