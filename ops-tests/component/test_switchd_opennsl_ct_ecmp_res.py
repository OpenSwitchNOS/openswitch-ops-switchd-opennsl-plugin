...
def ecmp_resilient_config_creation(sw1, sw2):
    ...
    sw1("ip route 70.0.0.0/24 1.0.0.1")
    sw1("ip route 70.0.0.0/24 2.0.0.1")
    sw1("ip route 70.0.0.0/24 3.0.0.1")
    out = sw1('do show run')
    assert "ip route 70.0.0.0/24 3.0.0.1" and "ip \
        route 70.0.0.0/24 1.0.0.1" \
        and "ip route 70.0.0.0/24 2.0.0.1" in out

    # Enabling static IPv6 routes on switch1
    sw1("ipv6 route 1090::/120 1030::1")
    sw1("ipv6 route 1090::/120 1020::1")
    sw1("ipv6 route 1090::/120 1040::1")
    out = sw1('do show run')
    assert "ipv6 route 1090::/120 1030::1" and \
        "ipv6 route 1090::/120 1020::1" and \
        "ipv6 route 1090::/120 1040::1" in out
