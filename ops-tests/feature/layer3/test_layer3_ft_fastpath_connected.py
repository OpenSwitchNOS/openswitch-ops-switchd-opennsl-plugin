...
def test_fastpath_routed(topology, step):
    ...
    L3.switch_cfg_iface(ops1, 'if01', '10.0.0.1/24', '2000::1/120')
    L3.switch_cfg_iface(ops1, 'if02', '11.0.0.1/24', '2002::1/120')
    sleep(10)

    L3.host_cfg_iface(hs1, 'eth0', '10.0.0.10/24', '2000::2/120')
    L3.host_cfg_iface(hs2, 'eth0', '11.0.0.10/24', '2002::2/120')

    L3.host_add_route(hs1, '0.0.0.0/0', '10.0.0.1')
    L3.host_add_route(hs2, '0.0.0.0/0', '11.0.0.1')
    L3.host_add_route(hs1, '::/0', '2000::1')
    L3.host_add_route(hs2, '::/0', '2002::1')

    # ---------- IPv4 ping between workstations ----------

    step("IPv4 ping between workstations")
    L3.host_ping_expect_success(1, hs2, hs1, '10.0.0.10')
    L3.host_ping_expect_success(1, hs1, hs2, '11.0.0.10')

    # ---------- Verifying HIT Bit in ASIC for IPv4 ping ----------

    step("Verifying HIT Bit in ASIC for IPv4 ping")
    L3.host_ping_expect_success(10, hs1, hs2, '11.0.0.10')
    verify_ipv4_hit_bit(ops1, '10.0.0.10', '11.0.0.10')

    # ---------- IPv6 ping between workstations ----------

    step("IPv6 ping between workstations")
    L3.host_ping_expect_success(1, hs2, hs1, '2000::2')
    L3.host_ping_expect_success(1, hs1, hs2, '2002::2')

    # ---------- Verifying HIT Bit in ASIC for IPv6 ping ----------

    step("Verifying HIT Bit in ASIC for IPv6 ping")
    L3.host_ping_expect_success(10, hs1, hs2, '2002::2')
    ...
    L3.host_ping_expect_success(1, hs1, ops1, '10.0.0.1')
    L3.host_ping_expect_success(1, hs1, ops1, '2000::1')
    L3.host_ping_expect_success(1, hs2, ops1, '11.0.0.1')
    L3.host_ping_expect_success(1, hs2, ops1, '2002::1')
